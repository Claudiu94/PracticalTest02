...
public class Constants {
    ...
    final public static String WEB_SERVICE_ADDRESS = "http://download.finance.yahoo.com/d/quotes.csv";
    ...
    final public static String QUERY_ATTRIBUTE = "?s=";
    final public static String QUERY_ATTRIBUTE1 = "&f=l1t1";
